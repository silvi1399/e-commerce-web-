...
function normalizeContent() {
  const replacements = [
    ...
    ['ðŸ”', 'Dock'],
    ['ðŸ›¡ï¸', 'Shield'],
    ['Shto nÃ« ShportÃ«', 'Add to Cart'],
    ['Kthehu nÃ« Produktet', 'Back to Products'],
    ['Shporta e Blerjes', 'Shopping Cart'],
    ['Kontakti', 'Contact'],
    ['Rreth Nesh', 'About Us'],
    ['PÃ«rmbledhje NÃ« ShportÃ«', 'Cart Summary'],
    ['DÃ«rgimi', 'Shipping'],
    ['Gjithsej', 'Total'],
    ['Vazhdo Blerjet', 'Continue Shopping'],
    ['Vazhdo nÃ« PagesÃ«n', 'Proceed to Checkout'],
    ['Nuk e GjetÃ«t PÃ«rgjigjen?', 'Didn’t find your answer?'],
    ['Nuk jeni i sigurt?', 'Need more confidence?'],
    ['DÃ«rgim falas nÃ« tÃ«rÃ« ShqipÃ«rinÃ«', 'Free shipping across Albania'],
    ['TÃ« gjitha tÃ« drejtat e ruajtura.', 'All rights reserved.']
  ];
